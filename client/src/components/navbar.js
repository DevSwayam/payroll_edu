    ...
    <div>
      <DropdownMenu onOpenChange={setIsOpen}>
        <DropdownMenuTrigger
          ...
          className="py-2.5 px-4 text-center capitalize rounded-lg duration-150 font-medium text-sm text-foreground bg-gray-800 hover:bg-gray-600 active:bg-gray-900 md:inline"
        >
