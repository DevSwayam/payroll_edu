    ...
    <section id="cta">
      <div className="py-14">
        <div className=" grid items-center justify-center">
          <div className="relative grid w-full flex-col items-center justify-center overflow-hidden">
            <Marquee
              reverse
            ...
            <div className="absolute z-10 w-full flex items-center jce">
              <div className=" bg-white/70 backdrop-blur-sm py-10">
